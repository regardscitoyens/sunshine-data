...
echo "ORIGIN,LABO,BENEF_PS_QUALITE_NOM_PRENOM,BENEF_PS_ADR,BENEF_PS_QUALIFICATION,BENEF_PS_RPPS,DECL_CONV_DATE,DECL_CONV_OBJET,DECL_CONV_PROGRAMME,BENEF_ETUD_ETA,BENEF_PS_CODEPOSTAL" > data/formatted/declaration_conventions.formatted.csv
...
cat data/raw/declaration_conventions.csv | sed 's/"//g' | sed 's/,/ /g' | awk -F ';' '{
LABO=$2
NOM=$8" "$7" "$28" "$30;
...
DATE=$33
OBJET=$34
PROGRAMME=$38" "$35" "$36" "$37
ETA=$27" "$28" "$29
CODEPOSTAL=$15
if ( $25 == "AUTRE") RPPS=""
print "EXPORT-ETALAB,"LABO","NOM",\""ADRESSE"\","QUALIF","RPPS","DATE","OBJET",\""PROGRAMME"\",\""ETA"\","CODEPOSTAL
}' | sed 's/, */,/g' | sed 's/," */,"/g' | sed 's/ *",/",/g'  | sed 's/ *,/,/g'  | sed 's/  */ /g' >> data/formatted/declaration_conventions.formatted.csv
