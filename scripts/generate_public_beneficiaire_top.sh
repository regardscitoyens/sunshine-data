...
echo 'BENEFICIAIRE,QUALIFICATION,DEPARTEMENT,NB TOTAL CONVENTIONS + AVANTAGES,NB CONVENTIONS,NB AVANTAGES,MONTANT AVANTAGES' > data/public/beneficiaires.top.csv
