...
data/formatted/medecins_exploitables.csv: scripts/format_exploitables_medecins.sh data/raw/medecins_exploitables.csv data/raw/internes.csv data/headers.csv
